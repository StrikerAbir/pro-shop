      ...
      <div className="card card-compact  bg-base-100 rounded-lg shadow-xl">
        ...
        <div className="card-body">
          <div className="flex items-center justify-between">
            ...
            <div>
              <p className="font-semibold">Price: ${products.original_price}</p>
            </div>
          </div>
          <div className="flex items-center justify-between">
            <div>
              <p className="font-semibold">Location: {products.location}</p>
            </div>
            <div>
              <p className="font-semibold">Condition: {products.product_condition}</p>
            </div>
          </div>
